...
-- AddForeignKey
ALTER TABLE "public"."drinks" ADD CONSTRAINT "drinks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."services" ADD CONSTRAINT "services_drink_id_fkey" FOREIGN KEY ("drink_id") REFERENCES "public"."drinks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
